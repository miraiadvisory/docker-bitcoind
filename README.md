...
Suitable image for using with [official Helm chart](https://github.com/helm/charts/tree/master/stable/bitcoind) and all available versions at [BitcoinCore](https://bitcoincore.org/en/releases/).

See [CREDITS.md](CREDITS.md) for kudos to the original creators.
